...
When `reporting a bug <https://github.com/oemof/oemof-tabular/issues>`_ please include:
...
1. Fork `oemof-tabular <https://github.com/oemof/oemof-tabular>`_
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.org/oemof/oemof-tabular/pull_requests>`_ for each change you add in the pull request.
