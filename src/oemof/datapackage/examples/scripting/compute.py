...
from oemof.datapackage.constraint_facades import CONSTRAINT_TYPE_MAP
from oemof.datapackage.facades import TYPEMAP
from oemof.datapackage.postprocessing import calculations
...
for example in examples:
    ...
    datapackage_dir = os.path.join(
        importlib.resources.files("oemof.datapackage"),
    ...
    # now we use the write results method to write the results in oemof-datapackage
    # format
